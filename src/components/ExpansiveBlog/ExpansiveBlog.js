...
function ExpansiveBlog(props, ref) {
	...
	const heightComponents = {
		page: () => {
			return expand
				? height * (7 / 8) +
						Math.ceil((itens.length - itensWithoutExpansive) / itensPerLine) *
							height *
							(8 / 21) +
						height / 14
	...
	return (
		<div
			ref={refDiv}
			className="blogPageItem"
			style={{
				height: heightComponents.page(),
				backgroundColor: backgroundColor[nameItens],
			}}
		>
			...
			<div
				className="blogItemBottomView"
				style={{ height: heightComponents.bottomView() }}
			>
